...
public sealed partial class AddSprint9AuthSchema : Migration
{
    protected override void Up(MigrationBuilder mb)
    {
        ...
        mb.AddColumn<DateTime>(name: "locked_until", table: "users", nullable: true);

        mb.AddColumn<DateTime>(name: "last_failed_login_at", table: "users", nullable: true);
        ...
        mb.CreateTable(
            ...
            constraints: table =>
                table.PrimaryKey("pk_user_recovery_codes", x => new { x.user_id, x.code_hash })
        );

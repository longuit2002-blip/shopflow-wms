...
public sealed class AdminUnlockAccountCommandHandlerTests
{
    ...
    private AdminUnlockAccountCommandHandler BuildHandler() =>
        new(_users, _auditLog, NullLogger<AdminUnlockAccountCommandHandler>.Instance);
    ...
    public async Task Happy_UnlocksTargetAndEmitsAuditAttributedToActor()
    {
        ...
        _users
            .GetByIdAsync(target.Id, Arg.Any<CancellationToken>())
